...
Obviňovat
#Epistemologický benchmark pro myši
## Struktura souborů
# Epistemologický benchmark pro myši
...
## Co testujeme?
- Schopnost rozpoznat AI epistemologickou perspektivu (pozorování bez předpokladů)
- Porozumění meta-jazykové vrstvy (otázka "Chceš myš?" jako otázka o systému)
- Detekci a analýza 12 kognitivních perspektiv v textu
...
-  ` epistemological_mouse_v2.json ` - benchmark metadat
